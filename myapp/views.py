...
def learning_dtl_view(request):
    c = {"name": "Sampurna Simkhada", "student": "Jane"}
    s = [
    ...
    c.update(students=s)  # {"name": "Prashiddha Joshi ", "student": "Jane", "students": []}
...
def contact_view(request):
    return render(request, template_name="myapp/contac.html")
